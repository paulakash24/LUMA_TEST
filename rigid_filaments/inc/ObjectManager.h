...
public:
	...
	void ibm_moveBodies(int level, int t, double dt);		// Update all IBBody positions and support.
	...
	void ibm_apply_prescribed_movement(int timeinstant, double dt);			//gives prescribed motion to the body
